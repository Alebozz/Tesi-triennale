...
FPDS: https://gram.web.uah.es/data/datasets/fpds/index.html
I dataset utilizzati sono stati soggetti a pre-processing. I dataset ottenuti dopo la fase di pre-processing sono archiviati su uno storage locale assieme ad altri dati ottenuti dall'esecuzione del codice.
